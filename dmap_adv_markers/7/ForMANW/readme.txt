...
Main advantages are:
  ...
  5. GUI controls for changing marker type and color
  
////////////////////////////////////////
// Installation

The d_map_adv_markers.pbo should be placed in appropriate addons directory.
...
5. Pressing Shift key on map temporary shows/hides channel of existing markers 
